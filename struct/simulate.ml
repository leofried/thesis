...
let run_one_sim (scheme : Scheme.t) (specs : Data.s) : float =
...
let simulate (scheme : Scheme.t) (specs : Data.s) (iters : int) : Data.t =
  Team.set_luck specs.luck;
  {
    scheme;
    specs;
    stats = Stats.of_list (List.init iters (fun _ -> run_one_sim scheme specs))
  }
;;

(*
let simulate_scheme (scheme : Scheme.t) (specs : Data.s) : Data.t =
  Team.set_luck specs.luck;
