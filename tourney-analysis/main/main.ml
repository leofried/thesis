...
let s = Scheme.create (module Proper) [2;3;2;0];;
let number_of_teams = Scheme.number_of_teams s;;
...
let schemes = [s; Scheme.create (module Proper) [2;3;2;0;0]];;
(*(
