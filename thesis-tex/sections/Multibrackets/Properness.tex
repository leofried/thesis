\sub {
    ...
    \begin{definition}{Labels Available to a Semibracket}{}
        Let $\A = \A_1 \to ... \to \A_k$ be a linear multibracket. We say a label $\LL$ is \i{available to the semibracket} $\A_i$ if $\LL$ is either
        \begin{enumerate}[(a)]
            \item a seed, or
            \item the name of a game in semibracket $\A_j$ for $j < i$,
        \end{enumerate}
        and $\LL$ is not on a starting line of any semibracket $\A_j$ for $j < i.$
    \end{definition}
