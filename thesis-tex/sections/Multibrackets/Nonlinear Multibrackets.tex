\sub {
    ...
    An simple example of a nonlinear multibracket was the format used by the 2023 Suncorp Super Netball Playoffs, sometimes called the Page-McIntyre system.
    %CITE
