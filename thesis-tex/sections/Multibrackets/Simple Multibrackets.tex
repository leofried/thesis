\sub{
    While the bracket is a very powerful and important tournament design, it has two intimately related shortcomings. First, brackets lead teams to play wildly different numbers of games: in the bracket $\bracksig{8; 0; 0; 0}$, for example, two teams will play three games, two teams will play two, and four teams will play only one.

    And second, brackets tend to do a very poor job of ranking teams beyond just selecting a winner. Again considering the bracket $\bracksig{8; 0; 0; 0}$: the first-place finisher by definition the team that remains undefeated, and we can easily grant the loser of the championship game second place, but the two semifinals losers both might have a claim to the third place, and sorting through the fifth- through eight-place finishes is even trickier.
    ...
    To do this, we consider a class of formats called \textit{simple multibrackets}.
    ...
    \begin{definition}{Primary Bracket}{}
        The first bracket in a multibracket is called the \textit{primary bracket.}
    \end{definition}
    ...
    \begin{definition}{Weakly Proper Simple Multibracket}{}
