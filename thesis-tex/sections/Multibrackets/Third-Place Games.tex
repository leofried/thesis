\sub{
    ...
    Consider the format used in the 2015 Asian Football Confederation Asian Cup: a bracket of signature $\bracksig{8; 0; 0; 0}$, with the loser of the championship game claiming second, plus a third-place game.
    ...
    \begin{definition}{Multibracket}{multi}
        A \textit{multibracket} $\A$ is defined by a sequence of non-semitrivial semibrackets $$\A = \A_1 \to ... \to \A_k,$$ and played out in the following way on an inputted list of teams $\T$:\\
    ...
    %finally, a quick note about ranking the rest of the teams.
}