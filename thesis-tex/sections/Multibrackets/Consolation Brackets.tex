\sub {
    ...
    We will see in the coming sections that many formats used in a variety of settings are actually just examples of multibrackets. Figure \ref{fig:zoo} gives an outline of what the space of multibrackets looks like.
