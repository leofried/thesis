\sub {
    ...
    %     A multibracket is \i{weakly efficient} if there are no games played within it such that both the winner and loser of that game are guaranteed to be ranked by the multibracket.
    % \end{definition}
