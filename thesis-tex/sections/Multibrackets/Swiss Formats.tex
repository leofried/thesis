...
% in general, formalizing with flowcharts might be better, and allow for a proof of conj, and of mxA being the only non-compacts

    Consider again the 1998 Men's College Basketball Maui Invitational, which used a proper linear multibracket of signature $\bracksig{8;0;0;0} \to \bracksig{1} \to \bracksig{2;0} \to \bracksig{1} \to \bracksig{4;0;0} \to \bracksig{1} \to \bracksig{2;0} \to \bracksig{1}.$

    \fig{0.7}{maui}{1998 Men's College Basketball Maui Invitational}
    ...
    \fig{0.4}{s3_flow}{Maui Invitational Flowchart}
