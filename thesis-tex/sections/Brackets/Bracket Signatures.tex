...
\fig{1}{cfp_start}{The 2024 College Football Playoff}

The numbers 1, 2, 3, and 4 indicate where $t_1, t_2, t_3,$ and $t_4$ in $\T$ are placed to start. In the actual 2024 College Football Playoff, the list of teams $\T$ was Michigan, Washington, Texas, and Alabama, in that order, so the bracket was filled in like so.

\fig{1}{cfp_middle}{The 2024 College Football Playoff After Team Placement}
...
\fig{1}{cfp_end}{The 2024 College Football Playoff After Completion}
...
\begin{definition}{Bracket Signature}{}
    The \i{signature} of an $r$-round bracket $\A$ is the list $\bracksig{a_0; ...; a_r}$ where $a_i$ is the number of teams the get $i$ byes.
\end{definition}
...
\fig{0.8}{wcc}{The 2024 WCC Men's Basketball Tournament}
