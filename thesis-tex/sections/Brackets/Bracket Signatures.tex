...
% It also gives us a handle on how many proper brackets exist for $n$ teams: there are exactly as many $n$-team proper brackets as there are partitions of $1$ into $n$ powers of $
