...
Seeding is typically used to reward better and more deserving teams. As an example, on the left is the eight-team bracket used in the 2005 National Basketball Association Eastern Conference Playoffs. At the end of the regular season, the top eight teams in the Eastern Conference were ranked and placed into the bracket which played out as shown on the right.

\fig{.7}{nba}{2005 NBA Eastern Conference Playoffs}{}
...
\fig{0.7}{nba_bad}{An Alternative Seeding of the 2005 NBA Eastern Conference Playoffs}
...
% \begin{definition}{Delayed Confrontation}{}
%     An elimination format has delayed 
% \end{definition}
