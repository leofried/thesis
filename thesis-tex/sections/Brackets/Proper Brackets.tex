...
\begin{definition}{Seeding}{}
    The \textit{seeding} of an $n$-team bracket is the arrangement of the labels $1$ through $n$ amongst the $n$ starting lines. Together, the shape and seeding fully specify a bracket.
\end{definition}

\begin{definition}{$i$-seed}{}
    The $i$-seed is $i$th team in list of teams $\T$ inputted to a bracket.
\end{definition}
