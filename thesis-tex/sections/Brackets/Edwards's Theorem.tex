...
\begin{enumerate}
    \item For $i < j < m,$ $\P{\W{t_i}{\C}} \geq \P{\W{t_j}{\C}}$
    \item $\P{\W{t_{m-1}}{\C}} \geq \P{\W{t_m}{\C}}$
    \item For $m \leq i < j,$ $\P{\W{t_i}{\C}} \geq \P{\W{t_j}{\C}}$
\end{enumerate}
...
\begin{align*}
    \P{\W{t_i}{\C}} &= \P{\W{t_i}{\B}}\\
    &= \sum_{k=n}^{n+m-1} \P{\W{t_i}{\B} \;\mid\; \W{t_k}{\A}}\cdot \P{\W{t_k}{\A}}\\
    &\geq \sum_{k=n}^{n+m-1} \P{\W{t_j}{\B} \;\mid\; \W{t_k}{\A}}\cdot \P{\W{t_k}{\A}}\\
    &=\P{\W{t_j}{\B}}\\
    &=\P{\W{t_j}{\C}}
\end{align*}
...
\begin{align*}
    \P{\W{t_{m-1}}{\C}} &= \P{\W{t_{m-1}}{\B}}\\
    &\geq \P{\W{t_m}{\B} \;\mid\; \W{t_m}{\A}}\\
    &\geq \P{\W{t_m}{\B} \;\mid\; \W{t_m}{\A}} \cdot \P{\W{t_m}{\A}}\\
    &= \P{\W{t_m}{\C}}
\end{align*}
...
\begin{align*}
    \P{\W{t_i}{\C}} &= \P{\W{t_i}{\B} \;\mid\; \W{t_i}{\A}}\cdot \P{\W{t_i}{\A}}\\
    &\geq \P{\W{t_i}{\B} \;\mid\; \W{t_i}{\A}}\cdot \P{\W{t_j}{\A}}\\
    &\geq \P{\W{t_j}{\B} \;\mid\; \W{t_j}{\A}}\cdot \P{\W{t_j}{\A}}\\
    &= \P{\W{t_j}{\C}}
\end{align*}
