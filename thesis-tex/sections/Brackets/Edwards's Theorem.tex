...
We now attempt to completely specify the set of ordered brackets, culminating in Corollary \ref{th:construct_order} and Theorem \ref{th:limit_order}, which together form Edwards's Theorem \cite{montana}.
