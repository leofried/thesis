\sub {
    ...
    But the evidence provided by Conjecture \ref{conj:randord} isn't that strong: Lemma \ref{th:rand_lemma} is true for all traditional brackets as well, even though they are not always ordered. Indeed, despite the lemma, Chung and Hwang turns out to be false due to a counterexample given by Israel \cite{seventeen_team}.
