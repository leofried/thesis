...
A list of teams being strongly stochastically transitive (or SST) captures the intuition that each team ought to do better against lower-seeded teams than against higher-seeded teams.
