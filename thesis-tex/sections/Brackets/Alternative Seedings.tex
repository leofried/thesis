\sub {
    ...
    %reseeding?
    %references [stronger player need not win more (!!!!!!!) -> think thru results]
    %(1-n) not nec ordered (tho is for balanced)
    %non-orderness can arise from more than just 0.5s
