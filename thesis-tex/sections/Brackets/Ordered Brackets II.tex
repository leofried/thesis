...
We begin with a theorem that allows us to combine two smaller ordered brackets together into a larger ordered one by having the winner of one of the brackets slot into the lowest seed starting line of the other. This is depicted in Figure \ref{fig:combine}.
