\sub{
    ...
    Clearly brackets are just networked knockout tournaments, but there are many knockout tournaments that aren't networked. The definition of a knockout tournament is designed to allow for the notions of byes, signatures, and properness to still apply.
