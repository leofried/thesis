\sub{
    ...
    \theo{theorem}{
        ...
        Since no reseeding is done in a bracket of two or fewer rounds, and since the traditional proper brackets of these signatures are ordered, so are the reseeded brackets.
    }{}{\fried}
