\sub{
    ...
    \theo{theorem}{
        ...
        But for $t_7$ to win the format, only two probability $p$ upsets are necessary: $t_7$ beating $t_2$ and $t_7$ beating $t_1$, as the winner of $t_4$ vs $t_5$ might beat $t_3$ in the semifinals. Thus,
