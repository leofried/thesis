\sub{
    ...
    The most common example of this is the third-place game, in which the losers of the two semifinal game play each other for third place. The 2015 Asian Football Confederation Asian Cup, which uses a $\bracksig{8; 0; 0; 0}$, employs a third-place game.

    \fig{.7}{third_place_game}{2015 AFL Asian Cup Knockout Stage}
    ...
    \fig{0.85}{third_place_game_bad}{2015 AFL Asian Cup First Alternative}
    ...
    \fig{0.85}{second_place_game}{2015 AFL Asian Cup Second Alternative}.
    ...
    \fig{0.85}{fourth_place_game}{2015 AFL Asian Cup Third Alternative}
