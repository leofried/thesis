...
Our new, nuanced alternative a proper bracket is an \textit{ordered bracket}, first defined by Chen and Hwang \cite{define_ordered}  (though we use the name proposed by Edwards \cite{montana}).
