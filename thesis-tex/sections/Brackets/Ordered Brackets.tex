...
\begin{definition}{Ordered}{}
    A tournament format $\A$ is \textit{ordered} if, for any SST list of teams, if $i < j$, then $\P{\W{t_i}{\A}} \geq \P{\W{t_j}{\A}}$
\end{definition}
...
\begin{align*}
   \P{\W{t_1}{\A}} = \P{\G{t_1}{t_2}} \geq 0.5 \geq \P{\G{t_2}{t_1}} = \P{\W{t_2}{\A}},
\end{align*}    
so $\A$ is ordered.
}{}
...
\theo{}{The four-team bracket $\bracksig{4; 0; 0}$ is ordered.}{Let $\A = \bracksig{4; 0; 0},$ and let $p_{ij} = \P{\G{t_i}{t_j}}.$ Then,
\begin{align*}
    \P{\W{t_1}{\A}} &= p_{14} \cdot (p_{23}p_{12} + p_{32} p_{13})\\
...
\end{align*}
\begin{align*}
    \P{\W{t_2}{\A}} &= p_{23} \cdot (p_{14}p_{21} + p_{41} p_{24})\\
    &\geq p_{32} \cdot (p_{14}p_{31} + p_{41} p_{34})\\
    &= \P{\W{t_3}{\A}}
\end{align*}
\begin{align*}
    \P{\W{t_3}{\A}} &= p_{32} \cdot (p_{14}p_{31} + p_{41} p_{34})\\
