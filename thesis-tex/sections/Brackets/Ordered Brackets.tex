\sub {
    ...
    One counterintuitive fact about the NCAA Basketball Tournament is that it is probably better to be a 10-seed than a 9-seed. (This doesn't violate the proper seeding property because 9-seeds have an easier first-round matchup than 10-seeds, and proper seedings only care about what happens if the bracket goes chalk, which would eliminate both the 9-seed and 10-seed in that round.) Why? Let's look at what seeds the $t_9$ and $t_10$ are likely to face in the first two rounds.
