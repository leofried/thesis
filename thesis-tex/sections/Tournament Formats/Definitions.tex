\sub{
    ...
    Before we begin our study, we set the stage by defining the key terms in the field of tournament design.

    Let $\T = [t_1, ..., t_n]$ be a list of teams. 
    ...
    \begin{definition}{Playing, Winning, Losing, and Beating}{}
