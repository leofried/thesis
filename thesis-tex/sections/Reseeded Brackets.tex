...
Edwards's Theorem naturally raises the question: is there some bracket-like tournament format, one where undefeated teams face off until only one reamins, that expands the space of signatures that are ordered? \i{Reseeded} brackets are our first attempt at an answer.
