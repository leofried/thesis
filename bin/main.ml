...
let f ~n ~iters_start ~iters_pow ~pool_counts ~max_games =
  ...
  Analysis.analyze_schemes ~iters_start ~iters_pow schemes
;;


(*f ~n:8 ~iters_pow:6 ~pool_counts:[1;2;3;4;8] ~max_games:4;;*)
